    ...
    <div>
      <div className="relative z-0 h-[320px]">
        <div className="absolute left-1/2 top-1/2 z-0 flex h-[490px] w-[490px] -translate-x-1/2 -translate-y-1/2 items-center justify-center">
          ...
          <img src="./images/pixelheart.png" alt="" className="w-16 h-12" />
          <span className="absolute bottom-1/2 left-1/2 z-10 flex w-0 origin-bottom justify-center h-[118px] rotate-[120deg]">
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-white rotate-[-120deg]">
              <FaReact className="text-blue-600 w-8 h-8" />
            </span>
          </span>
          <span className="absolute bottom-1/2 left-1/2 z-10 flex w-0 origin-bottom justify-center h-[118px] rotate-[240deg]">
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-white rotate-[-240deg]">
              <FaJava className="text-orange-700 w-8 h-8" />
            </span>
          </span>
          <span className="absolute bottom-1/2 left-1/2 z-10 flex w-0 origin-bottom justify-center h-[118px] rotate-[360deg]">
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-white rotate-[-360deg] ">
            <TbBrandKotlin className="w-8 h-8 text-purple-900" />
            </span>
          </span>
          <span className="absolute bottom-1/2 left-1/2 z-10 flex w-0 origin-bottom justify-center h-[170px] rotate-[180deg]">
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-white rotate-[-180deg]">
             
            </span>
          </span>
          <span className="absolute bottom-1/2 left-1/2 z-10 flex w-0 origin-bottom justify-center h-[170px] rotate-[60deg]">
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-white rotate-[-60deg]">
              <SiMongodb className="text-green-600 w-8 h-8" />
            </span>
          </span>
          <span className="absolute bottom-1/2 left-1/2 z-10 flex w-0 origin-bottom justify-center h-[170px] rotate-[300deg]">
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-white rotate-[-300deg]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="32px"
                height="32px"
          ...
          <span className="absolute bottom-1/2 left-1/2 z-10 flex w-0 origin-bottom justify-center h-[220px] rotate-[120deg]">
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-white rotate-[-120deg] opacity-5"></span>
          </span>
          <span className="absolute bottom-1/2 left-1/2 z-10 flex w-0 origin-bottom justify-center h-[220px] rotate-[240deg]">
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-white rotate-[240deg] opacity-5"></span>
          </span>
          <span className="absolute bottom-1/2 left-1/2 z-10 flex w-0 origin-bottom justify-center h-[220px] rotate-[360deg]">
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-white rotate-[360deg] opacity-5"></span>
          </span>
        </div>
      </div>
    </div>
